...
public class ThermodynamicsTest extends PJDependentTest {
    ...
    public static Collection<Object[]> data() {
        ...
        return Arrays.asList(new Object[][]{
            ...
            },
            {
                ...
                new double[]{-14.3232441, -14.2747628}, new double[]{-47.0065247, -45.1197988},
                ...
                new double[][][]{
                    ...
                    {
                        {
                            0.32458378634439816, -0.33464595812045317, 0.21247087522245356
                        },
                        {
                            -2.1088804470366007, -0.18290359797842404, -0.7158477527631455
                        },
                        {
                            -0.4416189323792056, 0.3919514976823814, -0.27720438558513494
                        },
                        {
                            -0.1294804178454096, 0.10345020607616712, -0.07562848810923899
                        },
                        {
                            -0.12170071648317518, -0.12226365328373433, -0.18708155978049848
                        },
                        {
                            -0.1338286311435242, 0.12067970333834377, -0.08762615563248195
                        },
                        {
                            -0.21577447110516454, -0.02282646302316161, 0.11687334540079769
                        },
                        {
                            0.6773203131299549, -0.05386903789837935, 0.2650867494115231
                        }
                    }
                }, new double[][][]{
                    {
            ...
            },
            {
                ...
                ThermoTestMode.GRAD, 0, 0, intRange(1, 9),
                new double[]{-22.8540579, -22.7550811}, new double[]{-130.57368, -134.280731},
                ...
                new double[][][]{
                    ...
                    {
                        {
                            1.6706084975962063,-1.6937770047376137,1.106802141033865
                        },
                        {
                            -10.813754091503991,-0.8713985481967065,-3.6157737201169713
                        },
                        {
                            -2.2178638141178446,2.059801949511704,-1.419491215634083
                        },
                        {
                            -0.6795107584726414,0.5219574236934761,-0.3970996777492302
                        },
                        {
                            -0.6038407042908908,-0.5739292769112831,-0.9718766996099327
                        },
                        {
                            -0.6662949350941254,0.5767521203139196,-0.4168216260322985
                        },
                        {
                            -1.136904097807642,-0.10294345088059145,0.5627500689737256
                        },
                        {
                            3.425345637997691,-0.3555757789961306,1.3369417304121436
                        }
                    }
                }, new double[][][]{
                    {
    ...
    public ThermodynamicsTest(String info, String[] filenames, ThermoTestMode mode,
        ...
        tempDir.mkdir();
        logger.info(String.format(" Running test %s in directory %s", info, tempDir));
